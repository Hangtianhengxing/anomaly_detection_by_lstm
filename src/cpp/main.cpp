...
int main(int argc, char **argv) {
    ...
    output_root_dirc = "/Users/sakka/cnn_anomaly_detection/data/output/human_area/20170422/";


    input_file_path = input_root_dirc + "201704220900.mp4";
    output_file_path = output_root_dirc + "human_9.csv";
    ...
    for (int i=10;i<17;i++){
        ...
        output_file_path = output_root_dirc + "human_" + std::to_string(i) + ".csv";
        human_area(input_file_path, human_mask_path, output_file_path);
    }
